...
class Generator(object):
    ...
    def gen_xml(self):
        return (self._generate_options == 'hb') or (self._generate_options == 'evt');
    ...
    def write(self):
        ...
        if not throttled and (not self.gen_xml()):
...
Add a Misc->Throttle block to your flow graph to avoid CPU congestion.''')
        ...
        if self.gen_xml():
            ...
            if(self._generate_options == 'evt'):
                self._flow_graph._suppress_io = True;
